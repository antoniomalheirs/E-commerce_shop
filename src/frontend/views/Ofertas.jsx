        ...
        <div>
          <div className="p-2">
            <div className="text-gray-300 my-3">
              ...
              <p className="text-justify leading-7 w-11/12 mx-auto">
                ...
                Reiciendis reprehenderit suscipit itaque molestiae accusantium a
                odio repellat provident. Aperiam labore adipisci illum ut
                tempore architecto iure dolorum dicta laborum perferendis?
              </p>
            </div>
          </div>
          ...
          <div className="flex mt-10 items-center gap-7">
            <div className="bg-red-600 p-5 rounded-lg">
              ...
              <p>
                <span className="md:text-base text-xs">Preço: R$ 29,90</span>
              </p>
            </div>
